...
function ButtonFn(
  ...
  const base = `inline-flex justify-center border items-center font-medium tracking-wide gap-2 whitespace-nowrap transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:selection`;
